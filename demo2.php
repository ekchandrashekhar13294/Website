                ...
                <div class="main-nav">
                  ...
                  <div id="menu" class="collapse">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="mega-menu five-col active"> <a href="carousel-sliders.html">Shortcodes</a> <span class="arrow"></span>
                        <ul>
                          ...
                          <li> <a href="#">Shortcodes 3</a> <span class="arrow"></span>
                            <ul>
                              ...
                              <li class="active"><a href="shortcodes-modal-popup.html"><i class="fa fa-search-plus" aria-hidden="true"></i> &nbsp; Modal Popup</a> </li>
                            </ul>
                          </li>
...
<div class="container-fluid" >
 ...
 <section class="sec-padding">
  ...
  <div class="row text-center">
          <button data-toggle="modal" data-target="#modal-switch" class="btn btn-default">Schedule Demo</button>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div id="modal-switch-label" class="modal-title"><h4>Schedule Demo</h4></div>
                </div>
                <div class="modal-body">
                <img src="http://via.placeholder.com/550x485" alt="" class="img-responsive"/>
